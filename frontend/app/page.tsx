...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#0d0d14] via-[#131328] to-[#0d0d14] overflow-hidden relative">
      ...
      {/* Slightly moved up the Welcome Section */}
